...
export interface IACLManagerInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "addAssetListingAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "addBridge", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "addEmergencyAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "addFlashBorrower", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "addPoolAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "addRiskAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "isAssetListingAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "isBridge", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "isEmergencyAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "isFlashBorrower", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "isPoolAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "isRiskAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "removeAssetListingAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "removeBridge", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "removeEmergencyAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "removeFlashBorrower", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "removePoolAdmin", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "removeRiskAdmin", values: [AddressLike]): string;
...
export interface IACLManager extends BaseContract {
    ...
    getFunction(nameOrSignature: "ASSET_LISTING_ADMIN_ROLE"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "BRIDGE_ROLE"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "EMERGENCY_ADMIN_ROLE"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "FLASH_BORROWER_ROLE"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "POOL_ADMIN_ROLE"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "RISK_ADMIN_ROLE"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "addAssetListingAdmin"): TypedContractMethod<[admin: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "addBridge"): TypedContractMethod<[bridge: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "addEmergencyAdmin"): TypedContractMethod<[admin: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "addFlashBorrower"): TypedContractMethod<[borrower: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "addPoolAdmin"): TypedContractMethod<[admin: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "addRiskAdmin"): TypedContractMethod<[admin: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "isAssetListingAdmin"): TypedContractMethod<[admin: AddressLike], [boolean], "view">;
    getFunction(nameOrSignature: "isBridge"): TypedContractMethod<[bridge: AddressLike], [boolean], "view">;
    getFunction(nameOrSignature: "isEmergencyAdmin"): TypedContractMethod<[admin: AddressLike], [boolean], "view">;
    getFunction(nameOrSignature: "isFlashBorrower"): TypedContractMethod<[borrower: AddressLike], [boolean], "view">;
    getFunction(nameOrSignature: "isPoolAdmin"): TypedContractMethod<[admin: AddressLike], [boolean], "view">;
    getFunction(nameOrSignature: "isRiskAdmin"): TypedContractMethod<[admin: AddressLike], [boolean], "view">;
    getFunction(nameOrSignature: "removeAssetListingAdmin"): TypedContractMethod<[admin: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "removeBridge"): TypedContractMethod<[bridge: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "removeEmergencyAdmin"): TypedContractMethod<[admin: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "removeFlashBorrower"): TypedContractMethod<[borrower: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "removePoolAdmin"): TypedContractMethod<[admin: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "removeRiskAdmin"): TypedContractMethod<[admin: AddressLike], [void], "nonpayable">;
