...
export interface HashflowLayerZeroMessengerInterface extends Interface {
    getFunction(nameOrSignature: "acceptOwnership" | "forceResumeReceive" | "hChainId" | "hChainIdToLzChainId" | "lzChainIdToHChainId" | "lzEndpoint" | "lzGasEstimate" | "lzReceive" | "owner" | "pendingOwner" | "renounceOwnership" | "retryPayload" | "retryableLayerZeroPayloads" | "router" | "setConfig" | "setReceiveVersion" | "setSendVersion" | "tradeXChain" | "transferOwnership" | "updateLzChainIdForHashflowChainId" | "updateLzEndpoint" | "updateLzGasEstimate" | "updateXChainRemoteAddress" | "withdrawFunds" | "xChainRemotes"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "LayerZeroMessageFailed" | "LayerZeroMessageMalformed" | "LayerZeroMessageReceive" | "LayerZeroMessageSend" | "LayerZeroMessageUnauthorized" | "LayerZeroPayloadStored" | "OwnershipTransferStarted" | "OwnershipTransferred" | "UpdateLzChainId" | "UpdateLzEndpoint" | "UpdateLzGasEstimate" | "UpdateXChainRemoteAddress"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "retryPayload", values: [BigNumberish, BytesLike, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "retryableLayerZeroPayloads", values: [BigNumberish, BytesLike, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "retryableLayerZeroPayloads", data: BytesLike): Result;
...
export declare namespace LayerZeroMessageFailedEvent {
    type InputTuple = [
        srcChainId: BigNumberish,
...
export declare namespace LayerZeroMessageMalformedEvent {
    type InputTuple = [
        srcChainId: BigNumberish,
        srcAddress: BytesLike,
        nonce: BigNumberish,
...
export declare namespace LayerZeroMessageReceiveEvent {
...
export declare namespace LayerZeroMessageSendEvent {
    type InputTuple = [txid: BytesLike];
    type OutputTuple = [txid: string];
    interface OutputObject {
        txid: string;
...
export declare namespace LayerZeroMessageUnauthorizedEvent {
    type InputTuple = [
        srcChainId: BigNumberish,
        srcAddress: BytesLike,
        nonce: BigNumberish
...
export declare namespace LayerZeroPayloadStoredEvent {
    type InputTuple = [
        srcChainId: BigNumberish,
        srcAddress: BytesLike,
        nonce: BigNumberish,
...
export interface HashflowLayerZeroMessenger extends BaseContract {
    ...
    getFunction(nameOrSignature: "hChainIdToLzChainId"): TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
    getFunction(nameOrSignature: "lzChainIdToHChainId"): TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "retryableLayerZeroPayloads"): TypedContractMethod<[
        arg0: BigNumberish,
        arg1: BytesLike,
        arg2: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "setReceiveVersion"): TypedContractMethod<[version: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "setSendVersion"): TypedContractMethod<[version: BigNumberish], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "updateLzEndpoint"): TypedContractMethod<[newLzEndpoint: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "updateLzGasEstimate"): TypedContractMethod<[newGasEstimate: BigNumberish], [void], "nonpayable">;
    ...
    getEvent(key: "LayerZeroMessageFailed"): TypedContractEvent<LayerZeroMessageFailedEvent.InputTuple, LayerZeroMessageFailedEvent.OutputTuple, LayerZeroMessageFailedEvent.OutputObject>;
    getEvent(key: "LayerZeroMessageMalformed"): TypedContractEvent<LayerZeroMessageMalformedEvent.InputTuple, LayerZeroMessageMalformedEvent.OutputTuple, LayerZeroMessageMalformedEvent.OutputObject>;
    getEvent(key: "LayerZeroMessageReceive"): TypedContractEvent<LayerZeroMessageReceiveEvent.InputTuple, LayerZeroMessageReceiveEvent.OutputTuple, LayerZeroMessageReceiveEvent.OutputObject>;
    getEvent(key: "LayerZeroMessageSend"): TypedContractEvent<LayerZeroMessageSendEvent.InputTuple, LayerZeroMessageSendEvent.OutputTuple, LayerZeroMessageSendEvent.OutputObject>;
    getEvent(key: "LayerZeroMessageUnauthorized"): TypedContractEvent<LayerZeroMessageUnauthorizedEvent.InputTuple, LayerZeroMessageUnauthorizedEvent.OutputTuple, LayerZeroMessageUnauthorizedEvent.OutputObject>;
    getEvent(key: "LayerZeroPayloadStored"): TypedContractEvent<LayerZeroPayloadStoredEvent.InputTuple, LayerZeroPayloadStoredEvent.OutputTuple, LayerZeroPayloadStoredEvent.OutputObject>;
    ...
    filters: {
        "LayerZeroMessageFailed(uint16,bytes,uint64)": TypedContractEvent<LayerZeroMessageFailedEvent.InputTuple, LayerZeroMessageFailedEvent.OutputTuple, LayerZeroMessageFailedEvent.OutputObject>;
        LayerZeroMessageFailed: TypedContractEvent<LayerZeroMessageFailedEvent.InputTuple, LayerZeroMessageFailedEvent.OutputTuple, LayerZeroMessageFailedEvent.OutputObject>;
        "LayerZeroMessageMalformed(uint16,bytes,uint64,bytes)": TypedContractEvent<LayerZeroMessageMalformedEvent.InputTuple, LayerZeroMessageMalformedEvent.OutputTuple, LayerZeroMessageMalformedEvent.OutputObject>;
        LayerZeroMessageMalformed: TypedContractEvent<LayerZeroMessageMalformedEvent.InputTuple, LayerZeroMessageMalformedEvent.OutputTuple, LayerZeroMessageMalformedEvent.OutputObject>;
        "LayerZeroMessageReceive(bytes32)": TypedContractEvent<LayerZeroMessageReceiveEvent.InputTuple, LayerZeroMessageReceiveEvent.OutputTuple, LayerZeroMessageReceiveEvent.OutputObject>;
        ...
        "LayerZeroMessageSend(bytes32)": TypedContractEvent<LayerZeroMessageSendEvent.InputTuple, LayerZeroMessageSendEvent.OutputTuple, LayerZeroMessageSendEvent.OutputObject>;
        LayerZeroMessageSend: TypedContractEvent<LayerZeroMessageSendEvent.InputTuple, LayerZeroMessageSendEvent.OutputTuple, LayerZeroMessageSendEvent.OutputObject>;
        "LayerZeroMessageUnauthorized(uint16,bytes,uint64)": TypedContractEvent<LayerZeroMessageUnauthorizedEvent.InputTuple, LayerZeroMessageUnauthorizedEvent.OutputTuple, LayerZeroMessageUnauthorizedEvent.OutputObject>;
        LayerZeroMessageUnauthorized: TypedContractEvent<LayerZeroMessageUnauthorizedEvent.InputTuple, LayerZeroMessageUnauthorizedEvent.OutputTuple, LayerZeroMessageUnauthorizedEvent.OutputObject>;
        "LayerZeroPayloadStored(uint16,bytes,uint64,bytes)": TypedContractEvent<LayerZeroPayloadStoredEvent.InputTuple, LayerZeroPayloadStoredEvent.OutputTuple, LayerZeroPayloadStoredEvent.OutputObject>;
        LayerZeroPayloadStored: TypedContractEvent<LayerZeroPayloadStoredEvent.InputTuple, LayerZeroPayloadStoredEvent.OutputTuple, LayerZeroPayloadStoredEvent.OutputObject>;
