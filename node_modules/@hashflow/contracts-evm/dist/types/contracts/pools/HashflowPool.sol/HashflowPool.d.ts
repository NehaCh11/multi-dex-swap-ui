...
export interface HashflowPoolInterface extends Interface {
    getFunction(nameOrSignature: "_WETH" | "approveToken" | "decreaseTokenAllowance" | "fillXChain" | "getReserves" | "increaseTokenAllowance" | "initialize" | "isValidSignature" | "killswitchOperations" | "name" | "nonces" | "operations" | "removeLiquidity" | "router" | "signerConfiguration" | "tradeRFQM" | "tradeRFQT" | "tradeXChainRFQM" | "tradeXChainRFQT" | "updateSigner" | "updateWithdrawalAccount" | "updateXChainMessengerAuthorization" | "updateXChainPoolAuthorization" | "xChainNonces"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Initialized" | "RemoveLiquidity" | "Trade" | "UpdateSigner" | "UpdateWithdrawalAccount" | "XChainTrade" | "XChainTradeFill"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "decreaseTokenAllowance", values: [AddressLike, AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "fillXChain", values: [AddressLike, BytesLike, AddressLike, AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "getReserves", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "increaseTokenAllowance", values: [AddressLike, AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "initialize", values: [string, AddressLike, AddressLike, AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "tradeXChainRFQT", values: [IQuote.XChainRFQTQuoteStruct, AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "updateXChainPoolAuthorization", values: [IHashflowPool.AuthorizedXChainPoolStruct[], boolean]): string;
    encodeFunctionData(functionFragment: "xChainNonces", values: [BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "xChainNonces", data: BytesLike): Result;
}
...
export interface HashflowPool extends BaseContract {
    ...
    getFunction(nameOrSignature: "signerConfiguration"): TypedContractMethod<[
    ], [
        [string, boolean] & {
            signer: string;
            enabled: boolean;
    ...
    getFunction(nameOrSignature: "updateSigner"): TypedContractMethod<[newSigner: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "xChainNonces"): TypedContractMethod<[arg0: BytesLike], [bigint], "view">;
