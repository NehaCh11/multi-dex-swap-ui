...
export interface IHashflowPoolInterface extends Interface {
    getFunction(nameOrSignature: "approveToken" | "decreaseTokenAllowance" | "fillXChain" | "getReserves" | "increaseTokenAllowance" | "initialize" | "isValidSignature" | "killswitchOperations" | "name" | "nonces" | "operations" | "removeLiquidity" | "router" | "signerConfiguration" | "tradeRFQM" | "tradeRFQT" | "tradeXChainRFQM" | "tradeXChainRFQT" | "updateSigner" | "updateWithdrawalAccount" | "updateXChainMessengerAuthorization" | "updateXChainPoolAuthorization"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "RemoveLiquidity" | "Trade" | "UpdateSigner" | "UpdateWithdrawalAccount" | "XChainTrade" | "XChainTradeFill"): EventFragment;
