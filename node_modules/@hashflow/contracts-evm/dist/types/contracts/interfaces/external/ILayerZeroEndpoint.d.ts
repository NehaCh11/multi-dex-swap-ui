...
export interface ILayerZeroEndpoint extends BaseContract {
    ...
    getFunction(nameOrSignature: "getReceiveLibraryAddress"): TypedContractMethod<[_userApplication: AddressLike], [string], "view">;
    getFunction(nameOrSignature: "getReceiveVersion"): TypedContractMethod<[_userApplication: AddressLike], [bigint], "view">;
    getFunction(nameOrSignature: "getSendLibraryAddress"): TypedContractMethod<[_userApplication: AddressLike], [string], "view">;
    getFunction(nameOrSignature: "getSendVersion"): TypedContractMethod<[_userApplication: AddressLike], [bigint], "view">;
