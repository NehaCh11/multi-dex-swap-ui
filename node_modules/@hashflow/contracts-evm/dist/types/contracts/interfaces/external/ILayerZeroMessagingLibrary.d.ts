...
export interface ILayerZeroMessagingLibraryInterface extends Interface {
    getFunction(nameOrSignature: "estimateFees" | "getConfig" | "send" | "setConfig"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setConfig", values: [BigNumberish, AddressLike, BigNumberish, BytesLike]): string;
