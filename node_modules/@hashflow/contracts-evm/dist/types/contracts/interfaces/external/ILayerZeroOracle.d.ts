...
export interface ILayerZeroOracleInterface extends Interface {
    getFunction(nameOrSignature: "getPrice" | "isApproved" | "notifyOracle"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "notifyOracle", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    decodeFunctionResult(functionFragment: "getPrice", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "isApproved", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "notifyOracle", data: BytesLike): Result;
}
export interface ILayerZeroOracle extends BaseContract {
    ...
    getFunction(nameOrSignature: "notifyOracle"): TypedContractMethod<[
        _dstChainId: BigNumberish,
        _outboundProofType: BigNumberish,
        _outboundBlockConfirmations: BigNumberish
    ], [
