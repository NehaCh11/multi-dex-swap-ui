...
declare const NETWORK_NAMES: readonly ["ethereum", "optimism", "arbitrum", "polygon", "bnb", "avalanche", "mumbai", "goerli", "bnb-testnet", "zksync-testnet"];
export declare type NetworkName = typeof NETWORK_NAMES[number];
export declare type NetworkNameExtended = NetworkName | typeof WORMHOLE_NETWORK_NAMES[number] | 'localhost';
declare type MainnetChainId = 1 | 137 | 56 | 42161 | 10 | 43114;
declare type TestnetChainId = 5 | 80001 | 97 | 280;
export declare type ChainId = MainnetChainId | TestnetChainId;
export declare type ChainIdExtended = ChainId | 1337 | 31337;
...
export declare type NetworkConfig = NetworkConfigBase & {
    name: NetworkName;
    chainId: ChainId;
};
declare type NetworkConfigExtended = NetworkConfigBase & {
