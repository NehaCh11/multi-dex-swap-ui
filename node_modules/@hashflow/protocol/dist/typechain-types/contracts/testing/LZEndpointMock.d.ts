...
export declare type PayloadClearedEvent = TypedEvent<[
    number,
    string,
    BigNumber,
    string
], PayloadClearedEventObject>;
export declare type PayloadClearedEventFilter = TypedEventFilter<PayloadClearedEvent>;
...
export declare type PayloadStoredEvent = TypedEvent<[
    number,
    string,
    string,
    BigNumber,
...
export declare type PayloadStoredEventFilter = TypedEventFilter<PayloadStoredEvent>;
export interface UaForceResumeReceiveEventObject {
    chainId: number;
    srcAddress: string;
}
export declare type UaForceResumeReceiveEvent = TypedEvent<[
    number,
    string
], UaForceResumeReceiveEventObject>;
export declare type UaForceResumeReceiveEventFilter = TypedEventFilter<UaForceResumeReceiveEvent>;
export interface ValueTransferFailedEventObject {
    to: string;
    quantity: BigNumber;
}
export declare type ValueTransferFailedEvent = TypedEvent<[
    string,
    BigNumber
], ValueTransferFailedEventObject>;
export declare type ValueTransferFailedEventFilter = TypedEventFilter<ValueTransferFailedEvent>;
