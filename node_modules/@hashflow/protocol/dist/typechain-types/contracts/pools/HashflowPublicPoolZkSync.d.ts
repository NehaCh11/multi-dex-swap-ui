...
export interface HashflowPublicPoolZkSyncInterface extends utils.Interface {
    functions: {
        "addLiquidity(address,(address,address,uint256,uint256,bytes))": FunctionFragment;
        "assetDetails(address)": FunctionFragment;
        ...
        "listAsset(address,uint256)": FunctionFragment;
        "migrateMode()": FunctionFragment;
        ...
        "updateCap(address,uint256)": FunctionFragment;
        "updateMigrateMode(bool)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "addLiquidity" | "assetDetails" | "authorizedRouters" | "depositYield" | "factory" | "fillXChain" | "getReserves" | "governance" | "hTokens" | "initialize" | "killswitchOperations" | "listAsset" | "migrateMode" | "migrateRouterAuthorization" | "name" | "nonces" | "operations" | "redeemXChainTokens" | "removeLiquidity" | "signerConfiguration" | "symbol" | "trade" | "tradeRFQm" | "tradeXChain" | "tradeXChainRFQm" | "transferAssets" | "updateCap" | "updateMigrateMode" | "updateRouterPermissions" | "updateSigner" | "updateWithdrawalAccount" | "updateXChainPoolAuthorization" | "updateXChainUa" | "xChainUa"): FunctionFragment;
    encodeFunctionData(functionFragment: "addLiquidity", values: [PromiseOrValue<string>, IQuote.DepositStruct]): string;
    encodeFunctionData(functionFragment: "assetDetails", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "authorizedRouters", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "depositYield", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "listAsset", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "updateCap", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "updateMigrateMode", values: [PromiseOrValue<boolean>]): string;
    ...
    events: {
        ...
        "DepositYield(address,uint256)": EventFragment;
        ...
        "UpdateCap(address,uint256)": EventFragment;
        "UpdateMigrateMode(bool)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "DepositYield"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "Initialized"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ListAsset"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "RemoveLiquidity"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "Trade"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "UpdateCap"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "UpdateMigrateMode"): EventFragment;
...
export interface DepositYieldEventObject {
    token: string;
    amount: BigNumber;
}
export declare type DepositYieldEvent = TypedEvent<[
    string,
    BigNumber
], DepositYieldEventObject>;
export declare type DepositYieldEventFilter = TypedEventFilter<DepositYieldEvent>;
...
export interface UpdateCapEventObject {
    token: string;
    cap: BigNumber;
}
export declare type UpdateCapEvent = TypedEvent<[
    string,
    BigNumber
], UpdateCapEventObject>;
export declare type UpdateCapEventFilter = TypedEventFilter<UpdateCapEvent>;
export interface UpdateMigrateModeEventObject {
    migrationMode: boolean;
}
export declare type UpdateMigrateModeEvent = TypedEvent<[
    boolean
], UpdateMigrateModeEventObject>;
export declare type UpdateMigrateModeEventFilter = TypedEventFilter<UpdateMigrateModeEvent>;
...
export interface HashflowPublicPoolZkSync extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HashflowPublicPoolZkSyncInterface;
    ...
    functions: {
        addLiquidity(liquidityProvider: PromiseOrValue<string>, deposit: IQuote.DepositStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        assetDetails(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
            BigNumber,
        ...
        depositYield(token: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        initialize(poolName: PromiseOrValue<string>, poolSymbol: PromiseOrValue<string>, poolSigner: PromiseOrValue<string>, poolOperations: PromiseOrValue<string>, hTokenImpl: PromiseOrValue<string>, poolGovernance: PromiseOrValue<string>, router: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        killswitchOperations(enabled: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        listAsset(token: PromiseOrValue<string>, cap: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        migrateMode(overrides?: CallOverrides): Promise<[boolean]>;
        ...
        removeLiquidity(token: PromiseOrValue<string>, liquidityProvider: PromiseOrValue<string>, burnAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        transferAssets(token: PromiseOrValue<string>, recipient: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        updateCap(token: PromiseOrValue<string>, cap: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        updateMigrateMode(newMigrateMode: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    xChainUa(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        addLiquidity(liquidityProvider: PromiseOrValue<string>, deposit: IQuote.DepositStruct, overrides?: CallOverrides): Promise<void>;
        assetDetails(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
        ...
        authorizedRouters(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        depositYield(token: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        factory(overrides?: CallOverrides): Promise<string>;
        ...
        governance(overrides?: CallOverrides): Promise<string>;
        hTokens(arg0: PromiseOrValue<BigNumberish>, arg1: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        initialize(poolName: PromiseOrValue<string>, poolSymbol: PromiseOrValue<string>, poolSigner: PromiseOrValue<string>, poolOperations: PromiseOrValue<string>, hTokenImpl: PromiseOrValue<string>, poolGovernance: PromiseOrValue<string>, router: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        killswitchOperations(enabled: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        listAsset(token: PromiseOrValue<string>, cap: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        migrateMode(overrides?: CallOverrides): Promise<boolean>;
        ...
        removeLiquidity(token: PromiseOrValue<string>, liquidityProvider: PromiseOrValue<string>, burnAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        signerConfiguration(overrides?: CallOverrides): Promise<[string, boolean] & {
            signer: string;
            enabled: boolean;
        }>;
        ...
        transferAssets(token: PromiseOrValue<string>, recipient: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        updateCap(token: PromiseOrValue<string>, cap: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        updateMigrateMode(newMigrateMode: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "DepositYield(address,uint256)"(token?: null, amount?: null): DepositYieldEventFilter;
        DepositYield(token?: null, amount?: null): DepositYieldEventFilter;
        ...
        "UpdateCap(address,uint256)"(token?: null, cap?: null): UpdateCapEventFilter;
        UpdateCap(token?: null, cap?: null): UpdateCapEventFilter;
        "UpdateMigrateMode(bool)"(migrationMode?: null): UpdateMigrateModeEventFilter;
        UpdateMigrateMode(migrationMode?: null): UpdateMigrateModeEventFilter;
    ...
    estimateGas: {
        ...
        assetDetails(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        migrateMode(overrides?: CallOverrides): Promise<BigNumber>;
        migrateRouterAuthorization(newRouter: PromiseOrValue<string>, oldRouter: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        assetDetails(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        migrateMode(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        migrateRouterAuthorization(newRouter: PromiseOrValue<string>, oldRouter: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
