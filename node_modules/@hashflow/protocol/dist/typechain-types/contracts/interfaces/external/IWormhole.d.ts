...
export interface IWormholeInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "chainId" | "getCurrentGuardianSetIndex" | "getGuardianSet" | "getGuardianSetExpiry" | "governanceActionIsConsumed" | "governanceChainId" | "governanceContract" | "isInitialized" | "messageFee" | "parseAndVerifyVM" | "parseVM" | "publishMessage" | "verifySignatures" | "verifyVM"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "verifyVM", values: [WormholeStructs.VMStruct]): string;
...
export interface IWormhole extends BaseContract {
    ...
    functions: {
        ...
        getGuardianSet(index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[WormholeStructs.GuardianSetStructOutput]>;
        ...
        parseVM(encodedVM: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[
            WormholeStructs.VMStructOutput
        ] & {
            vm: WormholeStructs.VMStructOutput;
        }>;
        ...
        verifySignatures(hash: PromiseOrValue<BytesLike>, signatures: WormholeStructs.SignatureStruct[], guardianSet: WormholeStructs.GuardianSetStruct, overrides?: CallOverrides): Promise<[boolean, string] & {
            valid: boolean;
            reason: string;
        }>;
        verifyVM(vm: WormholeStructs.VMStruct, overrides?: CallOverrides): Promise<[boolean, string] & {
            valid: boolean;
            reason: string;
        }>;
    };
    ...
    parseVM(encodedVM: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<WormholeStructs.VMStructOutput>;
    publishMessage(nonce: PromiseOrValue<BigNumberish>, payload: PromiseOrValue<BytesLike>, consistencyLevel: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
        from?: PromiseOrValue<string>;
    }): Promise<ContractTransaction>;
    verifySignatures(hash: PromiseOrValue<BytesLike>, signatures: WormholeStructs.SignatureStruct[], guardianSet: WormholeStructs.GuardianSetStruct, overrides?: CallOverrides): Promise<[boolean, string] & {
    ...
    estimateGas: {
        ...
        verifySignatures(hash: PromiseOrValue<BytesLike>, signatures: WormholeStructs.SignatureStruct[], guardianSet: WormholeStructs.GuardianSetStruct, overrides?: CallOverrides): Promise<BigNumber>;
        verifyVM(vm: WormholeStructs.VMStruct, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        verifySignatures(hash: PromiseOrValue<BytesLike>, signatures: WormholeStructs.SignatureStruct[], guardianSet: WormholeStructs.GuardianSetStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        verifyVM(vm: WormholeStructs.VMStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
