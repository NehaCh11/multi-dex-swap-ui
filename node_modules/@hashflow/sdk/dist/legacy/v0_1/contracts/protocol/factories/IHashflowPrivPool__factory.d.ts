...
import type { IHashflowPrivPool, IHashflowPrivPoolInterface } from "../IHashflowPrivPool";
export declare class IHashflowPrivPool__factory {
    ...
    static createInterface(): IHashflowPrivPoolInterface;
    static connect(address: string, runner?: ContractRunner | null): IHashflowPrivPool;
}
