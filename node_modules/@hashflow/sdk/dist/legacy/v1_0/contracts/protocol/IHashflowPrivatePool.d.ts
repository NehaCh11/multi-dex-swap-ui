...
export interface IHashflowPrivatePoolInterface extends Interface {
    getFunction(nameOrSignature: "addLiquidity" | "authorizedRouters" | "fillXChain" | "getReserves" | "governance" | "hTokens" | "initialize" | "killswitchOperations" | "listAsset" | "migrateRouterAuthorization" | "name" | "nonces" | "operations" | "redeemXChainTokens" | "removeLiquidity" | "signerConfiguration" | "symbol" | "trade" | "tradeRFQm" | "tradeXChain" | "tradeXChainRFQm" | "updateRouterPermissions" | "updateSigner" | "updateWithdrawalAccount" | "updateXChainPoolAuthorization" | "updateXChainUa"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AddLiquidity" | "ListAsset" | "RemoveLiquidity" | "Trade" | "UpdateRouterPermissions" | "UpdateSigner" | "UpdateWithdrawalAccount" | "UpdateXChainUA" | "XChainTrade"): EventFragment;
    encodeFunctionData(functionFragment: "addLiquidity", values: [AddressLike, AddressLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "listAsset", values: [AddressLike]): string;
...
export interface IHashflowPrivatePool extends BaseContract {
    connect(runner?: ContractRunner | null): IHashflowPrivatePool;
    ...
    listAsset: TypedContractMethod<[token: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "listAsset"): TypedContractMethod<[token: AddressLike], [void], "nonpayable">;
