...
export interface IHashflowPoolInterface extends Interface {
    getFunction(nameOrSignature: "authorizedRouters" | "fillXChain" | "getReserves" | "governance" | "hTokens" | "killswitchOperations" | "migrateRouterAuthorization" | "name" | "nonces" | "operations" | "redeemXChainTokens" | "signerConfiguration" | "symbol" | "trade" | "tradeRFQm" | "tradeXChain" | "tradeXChainRFQm" | "updateRouterPermissions" | "updateSigner" | "updateWithdrawalAccount" | "updateXChainPoolAuthorization" | "updateXChainUa"): FunctionFragment;
