...
import type { IHashflowPublicPool, IHashflowPublicPoolInterface } from "../IHashflowPublicPool";
export declare class IHashflowPublicPool__factory {
    ...
    static createInterface(): IHashflowPublicPoolInterface;
    static connect(address: string, runner?: ContractRunner | null): IHashflowPublicPool;
}
