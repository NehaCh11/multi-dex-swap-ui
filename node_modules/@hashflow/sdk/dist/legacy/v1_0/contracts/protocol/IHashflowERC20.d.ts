...
export interface IHashflowERC20Interface extends Interface {
    getFunction(nameOrSignature: "DOMAIN_SEPARATOR" | "allowance" | "approve" | "balanceOf" | "burn" | "decimals" | "initialize" | "mint" | "name" | "nonces" | "permit" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Approval" | "Transfer" | "UpdatePoolAuthorization"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "initialize", values: [string, string, BigNumberish, AddressLike]): string;
...
export interface IHashflowERC20 extends BaseContract {
    connect(runner?: ContractRunner | null): IHashflowERC20;
