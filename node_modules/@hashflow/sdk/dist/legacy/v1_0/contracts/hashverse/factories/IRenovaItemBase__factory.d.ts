...
import type { IRenovaItemBase, IRenovaItemBaseInterface } from "../IRenovaItemBase";
export declare class IRenovaItemBase__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): IRenovaItemBase;
}
