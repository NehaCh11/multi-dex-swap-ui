...
import type { IRenovaAvatarSatellite, IRenovaAvatarSatelliteInterface } from "../IRenovaAvatarSatellite";
export declare class IRenovaAvatarSatellite__factory {
    static readonly abi: readonly [{
        ...
        readonly name: "wormholeMintReceive";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    }];
    static createInterface(): IRenovaAvatarSatelliteInterface;
    static connect(address: string, runner?: ContractRunner | null): IRenovaAvatarSatellite;
}
