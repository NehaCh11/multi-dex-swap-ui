...
export interface IRenovaItemInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "getApproved" | "initialize" | "isApprovedForAll" | "mint" | "ownerOf" | "refreshAllMetadata" | "refreshMetadata" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setCustomBaseURI" | "setDefaultRoyalty" | "supportsInterface" | "transferFrom" | "updateMinterAuthorization" | "wormholeBridgeIn" | "wormholeBridgeOut"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "BatchMetadataUpdate" | "MetadataUpdate" | "Mint" | "Transfer" | "UpdateCustomURI" | "UpdateMinterAuthorization" | "XChainBridgeIn" | "XChainBridgeOut"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "updateMinterAuthorization", values: [AddressLike, boolean]): string;
    encodeFunctionData(functionFragment: "wormholeBridgeIn", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "wormholeBridgeOut", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "updateMinterAuthorization", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "wormholeBridgeIn", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "wormholeBridgeOut", data: BytesLike): Result;
}
...
export declare namespace UpdateMinterAuthorizationEvent {
    type InputTuple = [minter: AddressLike, status: boolean];
    type OutputTuple = [minter: string, status: boolean];
    interface OutputObject {
        minter: string;
        status: boolean;
    }
...
export declare namespace XChainBridgeInEvent {
    type InputTuple = [
        player: AddressLike,
        tokenId: BigNumberish,
        hashverseItemId: BigNumberish,
...
export declare namespace XChainBridgeOutEvent {
    type InputTuple = [
        player: AddressLike,
        tokenId: BigNumberish,
        hashverseItemId: BigNumberish,
...
export interface IRenovaItem extends BaseContract {
    ...
    getFunction(nameOrSignature: "updateMinterAuthorization"): TypedContractMethod<[
        minter: AddressLike,
        status: boolean
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "wormholeBridgeIn"): TypedContractMethod<[vaa: BytesLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "wormholeBridgeOut"): TypedContractMethod<[
        tokenId: BigNumberish,
        dstWormholeChainId: BigNumberish,
        wormholeMessageFee: BigNumberish
    ], [
    ...
    getEvent(key: "UpdateMinterAuthorization"): TypedContractEvent<UpdateMinterAuthorizationEvent.InputTuple, UpdateMinterAuthorizationEvent.OutputTuple, UpdateMinterAuthorizationEvent.OutputObject>;
    getEvent(key: "XChainBridgeIn"): TypedContractEvent<XChainBridgeInEvent.InputTuple, XChainBridgeInEvent.OutputTuple, XChainBridgeInEvent.OutputObject>;
    getEvent(key: "XChainBridgeOut"): TypedContractEvent<XChainBridgeOutEvent.InputTuple, XChainBridgeOutEvent.OutputTuple, XChainBridgeOutEvent.OutputObject>;
    filters: {
        ...
        "UpdateMinterAuthorization(address,bool)": TypedContractEvent<UpdateMinterAuthorizationEvent.InputTuple, UpdateMinterAuthorizationEvent.OutputTuple, UpdateMinterAuthorizationEvent.OutputObject>;
        UpdateMinterAuthorization: TypedContractEvent<UpdateMinterAuthorizationEvent.InputTuple, UpdateMinterAuthorizationEvent.OutputTuple, UpdateMinterAuthorizationEvent.OutputObject>;
        "XChainBridgeIn(address,uint256,uint256,uint16)": TypedContractEvent<XChainBridgeInEvent.InputTuple, XChainBridgeInEvent.OutputTuple, XChainBridgeInEvent.OutputObject>;
        XChainBridgeIn: TypedContractEvent<XChainBridgeInEvent.InputTuple, XChainBridgeInEvent.OutputTuple, XChainBridgeInEvent.OutputObject>;
        "XChainBridgeOut(address,uint256,uint256,uint16,uint256,uint256)": TypedContractEvent<XChainBridgeOutEvent.InputTuple, XChainBridgeOutEvent.OutputTuple, XChainBridgeOutEvent.OutputObject>;
        XChainBridgeOut: TypedContractEvent<XChainBridgeOutEvent.InputTuple, XChainBridgeOutEvent.OutputTuple, XChainBridgeOutEvent.OutputObject>;
    };
}
