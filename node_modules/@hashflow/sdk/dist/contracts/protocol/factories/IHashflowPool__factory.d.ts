...
import type { IHashflowPool, IHashflowPoolInterface } from "../IHashflowPool";
export declare class IHashflowPool__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): IHashflowPool;
}
