...
export declare namespace IRenovaCommandDeck {
    type ItemMintSpecStruct = {
        hashverseItemIds: BigNumberish[];
        rootId: BytesLike;
        proof: BytesLike[];
    };
    type ItemMintSpecStructOutput = [
...
export interface IRenovaCommandDeckInterface extends Interface {
    getFunction(nameOrSignature: "createQuest" | "depositTokenForQuest" | "hashflowRouter" | "initialize" | "itemMerkleRoots" | "mintItemAdmin" | "mintItems" | "questDeploymentAddresses" | "questIdsByDeploymentAddress" | "questOwner" | "renovaAvatar" | "renovaItem" | "updateHashflowRouter" | "updateQuestOwner" | "uploadItemMerkleRoot"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "CreateQuest" | "MintItems" | "UpdateHashflowRouter" | "UpdateQuestOwner" | "UploadItemMerkleRoot"): EventFragment;
    encodeFunctionData(functionFragment: "createQuest", values: [BytesLike, BigNumberish, BigNumberish, AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "depositTokenForQuest", values: [AddressLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "itemMerkleRoots", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "mintItemAdmin", values: [AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "mintItems", values: [AddressLike, IRenovaCommandDeck.ItemMintSpecStruct[]]): string;
    ...
    encodeFunctionData(functionFragment: "uploadItemMerkleRoot", values: [BytesLike, BytesLike]): string;
    decodeFunctionResult(functionFragment: "createQuest", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "depositTokenForQuest", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hashflowRouter", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "initialize", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "itemMerkleRoots", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mintItemAdmin", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "uploadItemMerkleRoot", data: BytesLike): Result;
}
...
export declare namespace MintItemsEvent {
    type InputTuple = [rootId: BytesLike, player: AddressLike];
    type OutputTuple = [rootId: string, player: string];
    interface OutputObject {
        rootId: string;
        player: string;
    }
...
export declare namespace UploadItemMerkleRootEvent {
    type InputTuple = [rootId: BytesLike, root: BytesLike];
    type OutputTuple = [rootId: string, root: string];
    interface OutputObject {
        rootId: string;
        root: string;
    }
...
export interface IRenovaCommandDeck extends BaseContract {
    ...
    getFunction(nameOrSignature: "depositTokenForQuest"): TypedContractMethod<[
        player: AddressLike,
        depositAmount: BigNumberish
    ], [
        void
    ...
    getFunction(nameOrSignature: "itemMerkleRoots"): TypedContractMethod<[rootId: BytesLike], [string], "view">;
    getFunction(nameOrSignature: "mintItemAdmin"): TypedContractMethod<[
        tokenOwner: AddressLike,
        hashverseItemId: BigNumberish
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "mintItems"): TypedContractMethod<[
        tokenOwner: AddressLike,
        mintSpecs: IRenovaCommandDeck.ItemMintSpecStruct[]
    ], [
        void
    ...
    getFunction(nameOrSignature: "uploadItemMerkleRoot"): TypedContractMethod<[
        rootId: BytesLike,
        root: BytesLike
    ], [
        void
    ...
    getEvent(key: "MintItems"): TypedContractEvent<MintItemsEvent.InputTuple, MintItemsEvent.OutputTuple, MintItemsEvent.OutputObject>;
    ...
    getEvent(key: "UploadItemMerkleRoot"): TypedContractEvent<UploadItemMerkleRootEvent.InputTuple, UploadItemMerkleRootEvent.OutputTuple, UploadItemMerkleRootEvent.OutputObject>;
    filters: {
        "CreateQuest(bytes32,address,uint256,uint256,address,uint256)": TypedContractEvent<CreateQuestEvent.InputTuple, CreateQuestEvent.OutputTuple, CreateQuestEvent.OutputObject>;
        CreateQuest: TypedContractEvent<CreateQuestEvent.InputTuple, CreateQuestEvent.OutputTuple, CreateQuestEvent.OutputObject>;
        "MintItems(bytes32,address)": TypedContractEvent<MintItemsEvent.InputTuple, MintItemsEvent.OutputTuple, MintItemsEvent.OutputObject>;
        MintItems: TypedContractEvent<MintItemsEvent.InputTuple, MintItemsEvent.OutputTuple, MintItemsEvent.OutputObject>;
        ...
        "UploadItemMerkleRoot(bytes32,bytes32)": TypedContractEvent<UploadItemMerkleRootEvent.InputTuple, UploadItemMerkleRootEvent.OutputTuple, UploadItemMerkleRootEvent.OutputObject>;
        UploadItemMerkleRoot: TypedContractEvent<UploadItemMerkleRootEvent.InputTuple, UploadItemMerkleRootEvent.OutputTuple, UploadItemMerkleRootEvent.OutputObject>;
    };
}
