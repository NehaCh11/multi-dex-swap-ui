...
import type { IRenovaAvatarBase, IRenovaAvatarBaseInterface } from "../IRenovaAvatarBase";
export declare class IRenovaAvatarBase__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): IRenovaAvatarBase;
}
