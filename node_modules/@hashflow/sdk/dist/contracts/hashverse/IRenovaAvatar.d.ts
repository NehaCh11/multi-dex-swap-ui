...
export interface IRenovaAvatarInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "characterIds" | "factions" | "getApproved" | "initialize" | "isApprovedForAll" | "mint" | "ownerOf" | "refreshAllMetadata" | "refreshMetadata" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setCustomBaseURI" | "supportsInterface" | "tokenIds" | "transferFrom" | "updateMaxCharacterId" | "updateMinStakePower" | "updateStakingVault" | "wormholeMintSend"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "BatchMetadataUpdate" | "MetadataUpdate" | "Mint" | "Transfer" | "UpdateCustomURI" | "UpdateMaxCharacterId" | "UpdateMinStakePower" | "UpdateStakingVault" | "XChainMintOut"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "initialize", values: [AddressLike, AddressLike, BigNumberish, AddressLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "updateMaxCharacterId", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "updateMinStakePower", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "updateStakingVault", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "wormholeMintSend", values: [BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "updateMaxCharacterId", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "updateMinStakePower", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "updateStakingVault", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "wormholeMintSend", data: BytesLike): Result;
}
...
export declare namespace UpdateMaxCharacterIdEvent {
    type InputTuple = [
        faction: BigNumberish,
        maxCharacterId: BigNumberish
    ];
    type OutputTuple = [faction: bigint, maxCharacterId: bigint];
    interface OutputObject {
        faction: bigint;
...
export declare namespace UpdateMinStakePowerEvent {
    type InputTuple = [minStakePower: BigNumberish];
    type OutputTuple = [minStakePower: bigint];
    interface OutputObject {
...
export declare namespace UpdateStakingVaultEvent {
    type InputTuple = [
        stakingVault: AddressLike,
        prevStakingVault: AddressLike
    ];
    type OutputTuple = [stakingVault: string, prevStakingVault: string];
    interface OutputObject {
        stakingVault: string;
...
export declare namespace XChainMintOutEvent {
    type InputTuple = [
        player: AddressLike,
        faction: BigNumberish,
        characterId: BigNumberish,
...
export interface IRenovaAvatar extends BaseContract {
    ...
    getFunction(nameOrSignature: "updateMaxCharacterId"): TypedContractMethod<[
        faction: BigNumberish,
        maxCharacterId: BigNumberish
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "updateMinStakePower"): TypedContractMethod<[minStakePower: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "updateStakingVault"): TypedContractMethod<[stakingVault: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "wormholeMintSend"): TypedContractMethod<[
        dstWormholeChainId: BigNumberish,
        wormholeMessageFee: BigNumberish
    ], [
        void
    ...
    getEvent(key: "UpdateMaxCharacterId"): TypedContractEvent<UpdateMaxCharacterIdEvent.InputTuple, UpdateMaxCharacterIdEvent.OutputTuple, UpdateMaxCharacterIdEvent.OutputObject>;
    getEvent(key: "UpdateMinStakePower"): TypedContractEvent<UpdateMinStakePowerEvent.InputTuple, UpdateMinStakePowerEvent.OutputTuple, UpdateMinStakePowerEvent.OutputObject>;
    getEvent(key: "UpdateStakingVault"): TypedContractEvent<UpdateStakingVaultEvent.InputTuple, UpdateStakingVaultEvent.OutputTuple, UpdateStakingVaultEvent.OutputObject>;
    getEvent(key: "XChainMintOut"): TypedContractEvent<XChainMintOutEvent.InputTuple, XChainMintOutEvent.OutputTuple, XChainMintOutEvent.OutputObject>;
    filters: {
        ...
        "UpdateMaxCharacterId(uint8,uint256)": TypedContractEvent<UpdateMaxCharacterIdEvent.InputTuple, UpdateMaxCharacterIdEvent.OutputTuple, UpdateMaxCharacterIdEvent.OutputObject>;
        UpdateMaxCharacterId: TypedContractEvent<UpdateMaxCharacterIdEvent.InputTuple, UpdateMaxCharacterIdEvent.OutputTuple, UpdateMaxCharacterIdEvent.OutputObject>;
        "UpdateMinStakePower(uint256)": TypedContractEvent<UpdateMinStakePowerEvent.InputTuple, UpdateMinStakePowerEvent.OutputTuple, UpdateMinStakePowerEvent.OutputObject>;
        UpdateMinStakePower: TypedContractEvent<UpdateMinStakePowerEvent.InputTuple, UpdateMinStakePowerEvent.OutputTuple, UpdateMinStakePowerEvent.OutputObject>;
        "UpdateStakingVault(address,address)": TypedContractEvent<UpdateStakingVaultEvent.InputTuple, UpdateStakingVaultEvent.OutputTuple, UpdateStakingVaultEvent.OutputObject>;
        UpdateStakingVault: TypedContractEvent<UpdateStakingVaultEvent.InputTuple, UpdateStakingVaultEvent.OutputTuple, UpdateStakingVaultEvent.OutputObject>;
        "XChainMintOut(address,uint8,uint256,uint16,uint256,uint256)": TypedContractEvent<XChainMintOutEvent.InputTuple, XChainMintOutEvent.OutputTuple, XChainMintOutEvent.OutputObject>;
        XChainMintOut: TypedContractEvent<XChainMintOutEvent.InputTuple, XChainMintOutEvent.OutputTuple, XChainMintOutEvent.OutputObject>;
    };
}
